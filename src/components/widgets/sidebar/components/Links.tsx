												...
												<p
													className={`mr-auto ${
														...
														activeRoute(route.path.toLowerCase())
															? 'text-700 font-medium text-primary dark:text-white'
										...
										<div>
											<p
												className={`mr-auto text-sm font-medium ${
													activeRoute(route.path.toLowerCase()) ? 'text-800 text-primary dark:text-white' : 'text-gray-600'
												} ${activeRoute(route.path.toLowerCase()) ? '22px' : '26px'}`}
											>
						...
						{route.icon ? (
							<div className='relative flex hover:cursor-pointer h-[62px]'>
								<li className='my-[3px] flex cursor-pointer items-center px-[30px]'>
									<span
										className={`${
											activeRoute(route.path) === true ? 'font-bold text-primary dark:text-white' : 'font-medium text-gray-600'
										}`}
									>
							...
							>
								<li className='my-[3px] flex cursor-pointeritems-center px-[34px]' key={key}>
									<span
										...
										} ${activeRoute(route.path) === true ? 'font-medium text-primary dark:text-white' : 'font-medium text-gray-600'}`}
									>
										{mini === false ? route.name : mini === true && hovered === true ? route.name : route.name[0]}
									</span>
								</li>
